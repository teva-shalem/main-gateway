declare module 'vue-cal' {
    ...
    export class VueCal extends Vue {
        $on<T extends keyof Events>(event: T, callback: EventListeners[T]): any
        ...
        minutesAtCursor(e: MouseEvent): void
         ...
         * @param {Boolean} next
         */
        previousNext(next: boolean): void
         ...
         */
        switchToNarrowerView(date?: Date | string): void
         ...
         */
        switchView(view: string, date?: Date, fromViewSelector?: boolean): void
         ...
         */
        createEvent(dateTime: string | Date, duration: number, eventOptions?: Events): any
