...
<b-container class="home">
    ...
    <b-row class="justify-content-center">
      <b-col lg="6" md="8">
        <p class="mt-2">
          <DrashTooltip term="wholeNature">טבע שלם</DrashTooltip> מהווה עמוד תווך בבניין חברה ישראלית מתוקנת בימינו - או בית שלישי. המיזם בונה מערכת הדרכה נפשית־גופנית־רוחנית לאדם המודרני המתמודד עם מורכבויות נפשו ויחסיו עם העולם. האדם עוסק בחלקה הפנימי בתפישה ע״י עיון ב<b-link href="https://books.teva-shalem.com/">ספרות הטבעדינמיקה</b-link>. מיסודות התפישה יוצר <b-link to="/art">אמנות</b-link> רב-תחומית המקיימת נדבך בלימוד וריפוי הנפש. משם נלמד תוכן ע״י <b-link to="/school">בית ספר פעימה</b-link> ב<b-link to="/luz">תוכנית שיעורים מסודרת</b-link> ושירותים שונים של בית הספר - לימודי דרך הפעימה. חלק מהשירותים ניתנים ב<b-link to="/home">טרפון 42</b-link>, משכן בית הספר המשמש בית שהוא מודל יזמי־חברתי מרפא, בכוונה להשתכפל ולהתרחב. 
        </p>
        <p>
          היבנות הדדית זו חלה ב<b-link to="healing-space">מרחבי הבראה</b-link> ברחבי הארץ, שהם אזורים נרחבים עם מספר יישובים והקשרים ביניהם, בהם מעמיקה ומתרחבת ההיבנות והערבות ההדדית, בין השאר ע״י <b-link href="https://books.teva-shalem.com/slideshow">המודל הטכנולוגי החכם</b-link>. 
        </p>
        <p>
